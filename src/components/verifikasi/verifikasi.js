        ...
        <div className='col-10 object-fit-cover text-center mb-3 mt-3'>
          ...
          <div className='col-10 ms-3'>  
            <div className="input-group">
              ...
              <div className="form-floating mb-3">
                <input type="text" className="form-control shadow-none border border-start-0 token" id="token" placeholder="name@example.com"/> 
          ...
          <div className='col-10 ms-3 mb-3'>  
            <button className='btn btn-dark w-100' onClick={pindahHalaman}>Verifikasi Email</button>
          </div>
